...
const Footer = () => {
  ...
  return (
    <footer
      ref={footerRef}
      className={`text-gray-600 body-font bg-gray-200 transition-all duration-300 ${
        isVisible ? 'transform scale-105' : ''
      }`}
    >
            ...
            {['Facebook', 'Twitter', 'Instagram', 'LinkedIn'].map((platform, idx) => (
              <a key={idx} className="ml-3 text-gray-500">
                <svg
                  ...
                  viewBox="0 0 24 24"
                >
                  {/* Example SVG for icons, you can replace with actual icons */}
